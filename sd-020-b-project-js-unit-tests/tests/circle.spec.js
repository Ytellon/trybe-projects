...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it ('Testa se o objeto retornado tem 3 propriedades.', () => {
    expect(Object.entries(circle(1)).length).toEqual(3);
  });
  ...
  it('Testa se dentro do objeto retornado, a função retorna uma key com value igual a circunferência correta para um círculo de raio 2.', () => {
    expect(circle(2).circumference).toBeCloseTo(12.56);
  });

  it('Testa se dentro do objeto retornado, a função retorna uma key com value igual a área correta para um círculo de raio 3.', () => {
    expect(Object.values(circle(3))[1]).toBeCloseTo(28.259);
  });

  it('Testa que a função retorna, num objeto, os dados corretos de um círculo de raio 3.', () => {
